...
Dataset_names_path = "data/license_plate_names.txt"
Dataset_train = "data/Dataset/train/license_plate_train.txt"
Dataset_test = "data/Dataset/test/license_plate_test.txt"
is_subfolder = True
